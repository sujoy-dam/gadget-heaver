...
const ReadGadger = ({ read,handleRemove }) => {
    
    // console.log(read)
    const {product_id, product_image, product_title, price, specification } = read
    return (
        <div className='flex border-4 gap-5 items-center mb-5 p-5 rounded-xl shadow-2xl bg-gray-100 max-w-6xl mx-auto'>
            ...
            <div className='w-full'>
                <div className='flex justify-between items-center'>
                    ...
                    <button onClick={()=>handleRemove(product_id)}><TiDeleteOutline className='text-4xl' /></button>
                </div>
